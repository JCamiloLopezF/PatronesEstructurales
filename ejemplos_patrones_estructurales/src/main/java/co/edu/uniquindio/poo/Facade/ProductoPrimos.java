...
public class ProductoPrimos implements PrimosInterface {
    private int numero1;
    private int numero2;

    public ProductoPrimos(int numero1, int numero2){
    ...
    public int MultiplicarPrimos(int numero1, int numero2){
